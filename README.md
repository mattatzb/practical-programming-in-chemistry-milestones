...
| Week | Milestone                                   | Link                                                                        |      
|------|---------------------------------------------|-----------------------------------------------------------------------------|
| 1    | Github Account Created                      | https://https://github.com/mattatzb                                               
| 1    | Github Profile Page                         | https://github.com/mattatzb/mattatzb                                   |
| 1    | Commit and Push Change from Command Line    | https://https://github.com/mattatzb/ppchem/commit/6548ef9315b60d65696125ffdc3dd1f99086a1d1                |
...
| 4    | Update `env.yml` via a Pull Request         | [https://github.com/`username`/practical-programming-in-chemistry-milestones/pull/`pull-request-number`](https://github.com/mattatzb/ppchem/pull/2) |
